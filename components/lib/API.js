...
const API = {
    ...
    authorizedJSONPut: async (path, data, token) => {
    ...
    authorizedJSONDelete: async (path, token) => {
    ...
    authorizedJSONGET: async (path, token) => {
    ...
    authorizedFilePost: async (path, formData, token) => {
