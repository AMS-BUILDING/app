            ...
            <ImageBackground source={HomeImage} style={styles.image}>
                <View style={[styles.features, { position: 'absolute', zIndex: 15 }]}>
                    ...
                    <View style={{ height: 400 }}>
                        <View style={{ backgroundColor: 'transparent', padding: 15, height: 300 }}>
                            <View style={[styles.featureItem, { justifyContent: 'center' }]}>
                                <Text style={styles.textNumber}>Xe ô tô:</Text>
                                <DropDownPicker
                                    open={open}
                                    value={id}
                                    items={items}
                            ...
                            <View style={{ marginTop: 10 }}>
                                <Text style={styles.textPrice}>Phí xe: {id == 3 ? currencyFormat(1000000?.toString()) : currencyFormat(1400000?.toString())}</Text>
