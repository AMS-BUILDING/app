...
export default function ApartmentCleaning({ navigation }) {
        ...
        <View style={styles.wrapContent}>
            ...
            <View style={styles.main}>
                <View style={styles.confirm}>
                    ...
                    <Text style={styles.textConfirm}>Vệ sinh căn hộ</Text>
                </View>

                <View style={styles.wrapTime}>
                    <View>
                        <Text style={{ marginBottom: 10 }}>Ngày đặt</Text>
                        <RNDateTimePicker value={new Date()} style={{ width: 100 }} />
                    </View>
                    <View style={styles.widthContent}>
                        <Text style={{ marginBottom: 10 }}>Loại căn hộ</Text>
                        <RNPickerSelect
                    ...
                    <View style={styles.widthContent}>
                        <Text style={{ marginBottom: 10 }}>Thời gian</Text>
                        <RNPickerSelect
                            style={pickerSelectStyles}
                            onValueChange={(value) => console.log(value)}
                            items={[
